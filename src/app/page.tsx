...
import { GrowingFigure } from "@/components/GrowingFigure";
...
export default function Home() {
  ...
  return (
    <div className="bg-white text-neutral-900 antialiased selection:bg-[#C8F169] selection:text-black font-sans min-h-screen">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-neutral-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => openModule("wizard")}>
            <div className="w-4 h-4 rounded-full bg-[#C8F169]"></div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-mraru-forest text-white text-sm font-medium px-5 py-2.5 rounded-full transition-transform hover:scale-[1.03] flex items-center gap-2 shadow-sm"
            >
              <ShieldCheck className="w-4 h-4 text-mraru-lime" />
      ...
      <main className="w-full overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-4">
          <div className="relative bg-mraru-lime rounded-[2.5rem] p-8 md:p-16 overflow-hidden min-h-[600px] md:min-h-[700px] flex flex-col md:block">
            {/* Hero Content */}
            <div className="relative z-10 max-w-xl mt-8 md:mt-16">
              <h1 className="font-display text-5xl md:text-7xl font-extrabold tracking-tight leading-[0.9] mb-6 text-mraru-forest">
                Invest for <br />
                the Future
                <span className="inline-block relative top-[-20px] ml-2">
                  <Star className="w-10 h-10 text-mraru-forest/80 fill-current inline" />
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <button
                  onClick={() => openModule("wizard")}
                  className="bg-mraru-forest text-white text-base font-medium px-7 py-3.5 rounded-full transition-transform hover:scale-[1.03] flex items-center gap-2 shadow-lg"
                >
                  <ShieldCheck className="w-5 h-5 text-mraru-lime" />
                  <span>Start Onboarding</span>
                </button>
                <a href="#features" className="text-base font-medium flex items-center gap-2 group text-mraru-forest">
                  Find Out More
            ...
            <div className="relative md:absolute md:top-12 md:-right-20 mt-12 md:mt-0 flex justify-center md:block transform scale-90 md:scale-100">
              ...
              <div className="absolute top-0 -left-20 md:-left-32 w-[280px] h-[580px] bg-white rounded-[3rem] border-[8px] border-white shadow-2xl rotate-[-6deg] overflow-hidden hidden lg:block opacity-90 z-0 text-neutral-900">
                ...
                <div className="p-4 space-y-4">
                  <div className="bg-mraru-forest text-white p-4 rounded-2xl">
                    <span className="text-xs text-neutral-400 uppercase">Dividend Strategy</span>
                    <div className="flex justify-between items-end mt-2">
                      <span className="text-2xl font-medium tracking-tight figure">+14.48%</span>
              ...
              {/* Front Phone */}
              <div className="relative w-[300px] h-[600px] bg-mraru-forest rounded-[3.5rem] border-[10px] border-mraru-forest shadow-2xl z-10 overflow-hidden">
                {/* Notch area */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-mraru-forest rounded-b-2xl z-20"></div>

                {/* Screen Content */}
                <div className="w-full h-full bg-mraru-forest text-white pt-10 px-6 flex flex-col">
                  {/* Header */}
                  ...
                  {/* Price — the signature "growing number", counts up on mount */}
                  <div className="mb-6">
                    <h2 className="font-display text-3xl font-extrabold tracking-tight">
                      <GrowingFigure value={1321500} prefix="KES " duration={1200} />
                    </h2>
                    <span className="text-mraru-lime text-sm font-medium figure">
                      +12.5% (+KES <GrowingFigure value={173000} duration={1200} />)
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <p className="text-sm font-medium figure">KES 1,304,200</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[10px] text-neutral-500 uppercase tracking-wider font-mono">High Pool</p>
                      <p className="text-sm font-medium figure">KES 1,330,000</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-auto pb-8 flex gap-3">
                    <button
                      onClick={() => openModule("governance")}
                      className="flex-1 bg-mraru-clay text-white font-medium py-3 rounded-xl transition-transform hover:scale-[1.03] text-xs"
                    >
                      Withdraw
                    </button>
                    <button
                      onClick={() => openModule("wizard")}
                      className="flex-1 bg-mraru-lime text-black font-medium py-3 rounded-xl transition-transform hover:scale-[1.03] text-xs"
                    >
                      Contribute
                    </button>
                  </div>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-24">
          <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tight mb-16 max-w-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-neutral-50 rounded-[2rem] p-10 relative overflow-hidden group hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="absolute -bottom-10 -right-10 w-48 h-48">
                <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#C8F169] rounded-full mix-blend-multiply opacity-80"></div>
            ...
            <div className="bg-neutral-50 rounded-[2rem] p-10 relative overflow-hidden group hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="absolute bottom-8 right-8 w-40 h-40">
                ...
                <div className="absolute inset-0 border-[12px] border-[#C8F169]/20 rounded-full border-l-[#C8F169] border-b-transparent -rotate-12 scale-75"></div>
                <svg
        ...
        <section id="advantages" className="max-w-7xl mx-auto px-6 mb-24">
          <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tight mb-6">Advantages</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#C8F169] flex items-center justify-center">
            ...
            {/* Item 2 */}
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#C8F169]/40 flex items-center justify-center">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-24">
          <div className="bg-mraru-forest rounded-[2.5rem] p-8 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between min-h-[400px]">
            <div className="relative z-10 w-full md:w-1/2">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-8 leading-[0.95]">
                Keep Your Finger on the <br />
                Investment Market Pulse
              </h2>
              <button
                onClick={() => openModule("wizard")}
                className="bg-mraru-lime text-mraru-forest text-sm font-semibold px-6 py-3 rounded-full transition-transform hover:scale-[1.03] flex items-center gap-2"
              >
                <ShieldCheck className="w-4 h-4 fill-current text-mraru-forest" />
                <span>Start Onboarding</span>
              </button>
            </div>
              ...
              <div className="bg-white rounded-3xl p-5 shadow-2xl relative">
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-display text-3xl font-extrabold tracking-tight">
                    <GrowingFigure value={1698831} prefix="KES " duration={1200} />
                  </h3>
                  <span className="inline-block bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-semibold mt-1 figure">
                    +KES 124,723 23.8%
                  </span>
                </div>
                <div className="bg-mraru-forest rounded-xl p-4 mb-4 text-white">
                  <div className="flex justify-between items-center text-white mb-2">
                    <span className="text-xs font-medium">Chama Account</span>
                    <MoreHorizontal className="w-4 h-4 text-neutral-500" />
                  </div>
                  <div className="text-white text-lg font-medium figure">KES 573,870</div>
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={() => openModule("governance")}
                      className="flex-1 bg-white/10 text-white text-[10px] py-1.5 rounded-lg border border-white/20 transition-transform hover:scale-[1.03]"
                    >
                      Governance
                    </button>
                    <button
                      onClick={() => openModule("wizard")}
                      className="flex-1 bg-mraru-lime text-mraru-forest text-[10px] py-1.5 rounded-lg font-bold transition-transform hover:scale-[1.03]"
                    >
                      Onboard
                    </button>
                  </div>
            ...
            {/* Background Abstract */}
            <div className="absolute inset-0 bg-gradient-to-r from-mraru-forest via-mraru-forest to-neutral-900">
        ...
        <section className="max-w-7xl mx-auto px-6 mb-32 flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-1/2 relative">
            <div className="absolute -top-4 -left-4 w-full h-full bg-[#C8F169] rounded-[2rem] transform -rotate-2"></div>
          ...
          <div className="w-full md:w-1/2">
            <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tight mb-6">Trade in Real Time</h2>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-32 flex flex-col-reverse md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2 relative h-[400px]">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#C8F169] rounded-full opacity-80"></div>
            ...
            <div className="absolute top-10 left-10 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 w-48 animate-bounce text-neutral-900">
              <div className="w-8 h-8 rounded-full bg-mraru-forest flex items-center justify-center">
              ...
              <div className="ml-auto text-xs font-semibold figure">KES 188,203</div>
            </div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 w-56 z-10 text-neutral-900">
              ...
              <div className="ml-auto text-right">
                <p className="text-xs font-semibold figure">KES 140,271</p>
            ...
            <div className="absolute bottom-20 right-10 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 w-48 animate-bounce text-neutral-900">
              ...
              <div className="ml-auto text-right">
                <p className="text-xs font-semibold figure">KES 669,120</p>
        ...
        {/* Bottom CTA */}
        <section className="max-w-7xl mx-auto px-6 mb-24 text-center">
          <h2 className="font-display text-3xl md:text-5xl font-extrabold tracking-tight mb-8">
            Get the App for Free <br /> and Start Now
          </h2>
          <button
            onClick={() => openModule("wizard")}
            className="bg-mraru-forest text-white text-base font-medium px-8 py-4 rounded-full transition-transform hover:scale-[1.03] inline-flex items-center gap-2 shadow-xl"
          >
            <ShieldCheck className="w-5 h-5 text-mraru-lime" />
            <span>Start Onboarding</span>
          </button>
      ...
      {/* Footer */}
      <footer className="bg-mraru-forest text-white pt-20 pb-10 rounded-t-[3rem] mt-10">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-neutral-900 border border-neutral-800 rounded-full py-3 pl-5 pr-12 text-sm text-white focus:outline-none focus:border-[#C8F169]"
                />
                <button className="absolute right-2 top-1.5 w-9 h-9 bg-[#C8F169] rounded-full flex items-center justify-center text-black hover:scale-105 transition-transform">
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          <div className="bg-white border border-neutral-100 text-neutral-900 rounded-[2.5rem] p-6 sm:p-10 max-w-5xl w-full my-auto space-y-6 shadow-2xl relative max-h-[90vh] overflow-y-auto font-sans">
            ...
            <div className="flex items-center justify-between border-b border-neutral-100 pb-4">
              <div className="flex items-center gap-3">
                <div className="w-3.5 h-3.5 rounded-full bg-[#C8F169]"></div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${
                    modalTab === "wizard"
                      ? "bg-[#C8F169] text-black shadow-sm"
