    ...
    <nav className="sticky top-0 z-50 w-full bg-[#09090b]/90 backdrop-blur-md border-b border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-5 h-5 rounded-full bg-[#C8F169] lime-glow flex items-center justify-center">
            <div className="w-2 h-2 rounded-full bg-black"></div>
          </div>
          <div>
            <span className="text-xl font-bold tracking-tight text-white">Mraru</span>
            <span className="ml-2 text-xs font-semibold px-2 py-0.5 rounded-full bg-[#C8F169]/10 text-[#C8F169] border border-[#C8F169]/20">
              Onboarding v1.0
            </span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-2 bg-neutral-900/80 p-1.5 rounded-full border border-neutral-800">
          <button
            ...
            className={`px-5 py-2 rounded-full text-xs font-medium transition-all flex items-center gap-2 ${
              activeTab === "wizard"
                ? "bg-[#C8F169] text-black font-semibold shadow-md"
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <RefreshCw className="w-3.5 h-3.5 text-[#C8F169]" />
            <span>Seed Demo Data</span>
          </button>

          <div className="hidden sm:flex items-center gap-2 bg-[#C8F169]/10 text-[#C8F169] px-3 py-1.5 rounded-full text-xs font-mono border border-[#C8F169]/20">
            <span className="w-2 h-2 rounded-full bg-[#C8F169] animate-ping"></span>
            System Live
          </div>
        </div>
      </div>
